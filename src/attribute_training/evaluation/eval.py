...
if __name__ == "__main__":
    ...
    parser.add_argument('--fpath_pred', type=str,
                        default='/scratch/bcgp/michal5/ecole_mo9_demo/src/attribute_training/classifiers/test_two_class_preds.npy')
    parser.add_argument('--fpath_label', type=str, 
                        default='/scratch/bcgp/datasets/visual_genome/vaw_dataset/gt/test_gt_three_classes.npy')
    
    parser.add_argument('--fpath_attribute_index', type=str,
                        default='/scratch/bcgp/datasets/visual_genome/vaw_dataset/data/attribute_index.json')
    parser.add_argument('--fpath_attribute_types', type=str,
                        default='/scratch/bcgp/datasets/visual_genome/vaw_dataset/data/attribute_types.json')
    parser.add_argument('--fpath_attribute_parent_types', type=str,
                        default='/scratch/bcgp/datasets/visual_genome/vaw_dataset/data/attribute_parent_types.json')
    parser.add_argument('--fpath_head_tail', type=str,
                        default='/scratch/bcgp/datasets/visual_genome/vaw_dataset/data/head_tail.json')

    parser.add_argument('--output', type=str, default='output_detailed.txt')
    
    args = parser.parse_args()

    pred = np.load(args.fpath_pred).squeeze(1)
