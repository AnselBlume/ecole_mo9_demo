...
if __name__ == '__main__':
    ...
    # tableware.component_concepts.update({ # Automatically via LLM
    #     part_name: Concept(name=part_name)
    #     for part_name in sorted(set(chain.from_iterable([
    #         retrieve_parts(concept_name, llm_client)
